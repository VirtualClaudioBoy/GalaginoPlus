...
void Menu::attract_resetTimer() {
  ...
  // l'utente sta interagendo davvero: se un gioco era in corso come demo
  // automatica, da qui in poi e' un player vero (riattiva l'audio se
  // MASTER_ATTRACT_MUTE_AUDIO lo aveva silenziato)
  attractPlay = false;
}
